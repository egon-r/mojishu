...
namespace Games.Shared.Data
{
    public class KanjiData_Top100MostFrequent
    {
        public static List<KanjiInfo> Kanji = new()
        {
            ...
            new KanjiInfo(
                "政",
                new KanjiClass[] { KanjiClass.TOP_100_MOST_FREQUENT, KanjiClass.JLPT_N3 },
                new string[] { "セイ" },
                new string[] { "sei" },
                new string[] { "まつりごと" },
            ...
            new KanjiInfo(
                "党",
                new KanjiClass[] { KanjiClass.TOP_100_MOST_FREQUENT, KanjiClass.JLPT_N2 },
                new string[] { "トウ" },
                new string[] { "tou" },
                new string[] { "" },
                new string[] { "" },
            ...
            new KanjiInfo(
                "氏",
                new KanjiClass[] { KanjiClass.TOP_100_MOST_FREQUENT, KanjiClass.JLPT_N1 },
                new string[] { "シ" },
                new string[] { "shi" },
                new string[] { "うじ" },
                new string[] { "uji" },
